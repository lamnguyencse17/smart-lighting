      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = req.params.id;
            _context.next = 3;
            return _devices["default"].readDeviceById(id);
...
router.post("/", /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var _req$body, name, device_id, result;

    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, device_id = _req$body.device_id;
            _context2.next = 3;
            return _devices["default"].createDevice({
              name: name,
              device_id: device_id
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = req.body.id;
            _context3.next = 3;
            return _devices["default"].deleteDevice(id);
